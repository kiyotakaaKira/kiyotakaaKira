...
<img src="https://raw.githubusercontent.com/kiyotakaaKira/kiyotakaaKira/main/assets/hero.svg " width="100%"/>

<br/><br/>

<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=500&size=18&duration=2600&pause=900&color=8B8BF5&center=true&vCenter=true&width=560&lines=AI+Systems+Engineer;Backend+Architect;AI+Security+Researcher;Founder;Hackathon+Builder;Open+Source+Developer" alt="rotating roles"/>
...
<table align="center">
<tr>
<td align="center"><b>Mission</b><br/>Building Valsia</td>
<td align="center"><b>Focus</b><br/>Agent Security</td>
<td align="center"><b>Repositories</b><br/>8 shipped</td>
<td align="center"><b>Hackathons</b><br/>10+</td>
<td align="center"><b>Status</b><br/>Shipping</td>
...
<img src="https://raw.githubusercontent.com/kiyotakaaKira/kiyotakaaKira/main/assets/divider.svg" width="100%"/>

## Mission Control

<table>
<tr><td width="20%"><b>Founder</b></td><td>Valsia — AI career-readiness engine, 4 co-founders, Phase 1 MVP</td></tr>
<tr><td><b>Current Research</b></td><td>Prompt-injection resistance, agent-to-agent trust boundaries</td></tr>
<tr><td><b>Current Stack</b></td><td>Next.js · Node.js/Express · MongoDB Atlas · Supabase · Docker · Local + hosted LLMs</td></tr>
<tr><td><b>Current Architecture</b></td><td>Security-first agentic systems — assume failure, assume attack, assume no one's watching</td></tr>
<tr><td><b>Current Goal</b></td><td>Take Valsia past MVP while consolidating parallel hackathon builds into fewer, deeper products</td></tr>
</table>
...
<sub><i>Every card is backed by a repo I opened and read directly — no invented projects.</i></sub>
...
**Backend**
Node.js · Express · REST · SSE

</td>
<td width="25%" valign="top" align="center">

**AI**
Llama 3.2 · Gemini · Featherless · Local LLM (GGUF)

</td>
<td width="25%" valign="top" align="center">

**Security**
Threat modeling · Zero trust · Agent security
...
**Infrastructure**
Docker · MongoDB Atlas · Supabase

</td>
<td width="25%" valign="top" align="center">

**Cloud**
Vercel · Firebase Storage

</td>
<td width="25%" valign="top" align="center">

**Cybersecurity**
Linux · Networking · CTF-style practice
...
```
Threat Modeling      ▰▰▰▰▰▱▱   Applied across every product before ship
Agent Security       ▰▰▰▰▱▱▱   Core focus for Valsia's next phase
Secure APIs          ▰▰▰▰▰▰▱   RBAC + scoped access across 4 products
Zero Trust           ▰▰▰▱▱▱▱   Assume breach — actively deepening
Prompt Injection     ▰▰▰▱▱▱▱   Researching fallback + input isolation
LLM Guardrails       ▰▰▰▱▱▱▱   Being built into Valsia's inference layer
```
...
**A system that hasn't been asked what happens when it's wrong, attacked, or unwatched isn't shipped — it's just deployed.**
